...
// creation the graphs base & grabbing the scatter id for placement 
var svg = d3
  .select("#scatter")
  .append("svg")
  .attr("width", width)
...
//an element that holds the bottom label 
svg.append("g").attr("class", "xText");
// placing the above element in reuseable variable 
var xText = d3.select(".xText");


//transforming text (the labels) at the bottom of the chart
...
//Appending the 3 files to correspond with the transition of y axes (values on the chart)
// 1. Poverty
xText
  .append("text")
  .attr("y", -26)
